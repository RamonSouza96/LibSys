...
type
  ...
  public
    ...
    class function IsBookExists(ANomeLivro: string): Boolean;
  end;
...
class function TBookManagerController.IsBookExists(ANomeLivro: string): Boolean;
var
  LCon: TFDConnection;
  LQry: TFDQuery;
  LSql: string;
begin
  ...
  LQry.Connection := LCon;
  try
    LSql := 'SELECT COUNT(*) FROM Livros WHERE LIV_NOME_LIVRO = :NOME_LIVRO';
    ...
    begin
      ...
      SQL.Clear;
      SQL.Add(LSql);
      ParamByName('NOME_LIVRO').AsString := ANomeLivro;
      Open;
