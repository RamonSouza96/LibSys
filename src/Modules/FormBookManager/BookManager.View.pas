...
uses
  ...
  Skia, FMX.Edit, FMX.Layouts, FMX.Skia, FMX.Effects, FMX.Controls.Presentation,
  FMX.StdCtrls, FMX.ListView, FMX.ListBox, FMX.DateTimeCtrls, FMX.EditBox,
  FMX.NumberBox, FMX.Memo.Types, FMX.ScrollBox, FMX.Memo, FMX.Menus;

type
  TFormBookManager = class(TForm)
    RectBookBackgraund: TRectangle;
    Layout2: TLayout;
    LvLivros: TListView;
    ...
    procedure EdtLivroNomeKeyUp(Sender: TObject; var Key: Word;
      var KeyChar: Char; Shift: TShiftState);
    procedure DeleteItemClick(Sender: TObject);
    procedure LvLivrosItemClick(const Sender: TObject;
      const AItem: TListViewItem);
    procedure SkSvgFormBookBackClick(Sender: TObject);
  private
...
procedure TFormBookManager.DeleteItemClick(Sender: TObject);
begin
  TBookManager_Settings.DeleteBook;
end;
...
procedure TFormBookManager.EdtLivroNomeKeyUp(Sender: TObject; var Key: Word;
  var KeyChar: Char; Shift: TShiftState);
begin
  if (Key = vkTab) or (Key = vkReturn) then
    TBookManager_Settings.NextInput;
end;
...
procedure TFormBookManager.LvLivrosItemClick(const Sender: TObject;
  const AItem: TListViewItem);
begin
 TBookManager_Settings.ListViewItemClick(AItem);
end;
...
procedure TFormBookManager.SkSvgFormBookBackClick(Sender: TObject);
begin
 TBookManager_Settings.FormBookManagerClose;
end;
