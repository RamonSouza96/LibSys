...
uses
  ...
  FMX.Dialogs, FMX.Objects, FMX.ListView.Types, FMX.ListView.Appearances,
  FMX.ListView.Adapters.Base, FMX.ListView, FMX.Layouts, Skia, FMX.Skia,
  FMX.Effects, FMX.Controls.Presentation, FMX.StdCtrls, FMX.Edit,
  FMX.Memo.Types, FMX.ScrollBox, FMX.Menus, FMX.Memo;
...
begin
  TUser_Settings.FInputFocus := Sender;
end;
...
begin
  TUser_Settings.FInputFocus := EdtCadNome;
end;
